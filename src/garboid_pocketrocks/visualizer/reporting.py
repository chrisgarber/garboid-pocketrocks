...
<section class="panel"><h2>Profit on won non-loan auctions</h2><div id="bot-profit" class="chart"></div><p class="note">Resource value under that game's chart, or investment payout, minus the winning payment.</p></section>
